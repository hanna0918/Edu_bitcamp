...
function hiddenMap(){
    const hiddenMapDoc = document.querySelector("#hiddenMap");
    if(hiddenMapDoc.style.visibility == "hidden"){
        hiddenMapDoc.style.visibility = "";
    }else {
        hiddenMapDoc.style.visibility = "hidden";
    }
}
...
// 지도 클릭하면 지도에 마커 생성하고 latlng 변수에 값 저장
