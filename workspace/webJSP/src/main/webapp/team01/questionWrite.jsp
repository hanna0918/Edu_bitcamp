...
@import url('https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_20-07@1.0/IBMPlexSansKR-Regular.woff') format('woff');
	...
	.freeboardWrite{
		max-width:1100px;   /*대표 이미지 설정 없을 경우 max-width:1100px; padding-left: 0; */
		/* padding-left:250px; */ /**/
		padding-right:10px; 
		width:100%;
		margin:0 auto;
	...
	.freeWriteHeaderLine>div:first-child{
		font-size:2em;
		float: left;
    	width:5%;
    	color: #4a4a4a;
	...
	.freeWriteHeaderLine>div:last-child{
		width:80%;
		float: left;
		font-size:1.1em;
		color:gray;
	...
	input[name=board_subject], input[name=board_subject]:focus{
		width:80%;
		outline:none;
		font-size:0.8em; 
	}
	...
	<div class="freeboardWrite">
		<div class="freeWriteHeader"> 
			<div class="freeWriteHeaderLine">
				<div>Q&A</div><div>궁금한건 못참지! 궁금한건 공유해보세요!</div>
				<!-- <div>
		...
		<form method="post" action="/itda/freeEditOk" style="width:100%; overflow:auto;">
				...
				<div class="freewriteBody">
					<div class="freebodyBlack">
						<div class="freeleftIdImg">
							<div id="profilImg">
								<img src="../img/circle.png" alt="프로필이미지"/>
							</div>
							<div id="profilId" style="  padding-top: 10px; padding-left: 0px;">
								<div id="freeleftId"> ${lognickname}&nbsp; @${login} </div>
							</div>
						</div> 
						...
						<input type="hidden" name="board_seq" value="${vo.board_seq }"/>
					      ...
					      <a href="/itda/freeEditOk"><input type="submit" value="등록" id="freeObtn" /></a>
        				  <a href="/itda/freeBoard2"><input type="submit" value="취소" id="freeXBtn" style="float:right; background: #fff; border: 1px solid #d3d3d3;color: #4a4a4a;margin-right: 7px;padding: 6.5px 12px;border-radius: 3px;font-size: 12.2px;font-weight: bold;"/></a>
